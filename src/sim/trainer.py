...
class Trainer:
    ...
    def __init__(self, args, ngpus_per_node):
        ...
        print('加载hw_model........')
        self.hw_tokenizer,self.hw_model = load_hw_main()
        print('已经加载完成hw_model。')

        train_dataset = Dataset(path=args.train_path, task=args.task, hw_tokenizer = self.hw_tokenizer)
        valid_dataset = Dataset(path=args.valid_path, task=args.task, hw_tokenizer = self.hw_tokenizer) if args.valid_path else None
    ...
    def eval_epoch(self, epoch) -> Dict:
        ...
        for i, batch_dict in enumerate(self.valid_loader):
            ...
            outputs = self.model(self.hw_model,**batch_dict)
